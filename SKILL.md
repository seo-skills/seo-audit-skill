...
SEOmator provides comprehensive website auditing by analyzing website structure and content against **287 rules** across **20 categories**.
...
This skill enables AI agents to audit websites for **287 rules** in **20 categories**, including:
...
- **Full rules reference**: See `docs/SEO-AUDIT-RULES.md` for all 287 rules
