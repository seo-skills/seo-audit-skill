---
name: seo-audit
description: Audit websites for SEO, technical, content, security, JS rendering, and AI readiness using SEOmator CLI. Returns LLM-optimized reports with health scores across 303 rules and 20 categories, and can diff two audits to show what a deploy changed. Use when analyzing websites, debugging SEO issues, checking site health, or comparing a site before and after a change.
license: MIT
...
SEOmator provides comprehensive website auditing by analyzing website structure and content against **303 rules** across **20 categories**.
...
This skill enables AI agents to audit websites for **303 rules** in **20 categories**, including:
...
- **Full rules reference**: See `docs/SEO-AUDIT-RULES.md` for all 303 rules
