...
/**
 * Emblem plus wordmark, sized by height.
 */
  ...
  return (
    ...
    >
      <g transform="translate(0 -2)" fill="currentColor">
        <circle cx="101.5" cy="101.5" r="101.5" transform="translate(0 2)" fill="#064ada" />
        <path d={MARK_DOME} transform="translate(37.409 85.505)" fill="#fff" />
        <path d={WORDMARK} transform="translate(259 160)" />
      </g>
    </svg>
  );
}
...
/**
 * The emblem on its own, for places too tight for the wordmark.
 */
